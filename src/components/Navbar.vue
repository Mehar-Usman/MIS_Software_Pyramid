    ...
    <div class="flex justify-between px-4 items-center relative">
      ...
      <div class="hidden sm:flex">
        <ul class="flex space-x-2 lg:space-x-5 text-white whitespace-nowrap">
          <li>
            <router-link  to="/home" :class="{ active: activeItem === 'Home' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Home</router-link>
          </li>
          <li>
            <router-link to="/salary" :class="{ active: activeItem === 'Salary' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Salary</router-link>
          </li>
          <li>
            <router-link to="/increments" :class="{ active: activeItem === 'Increments' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Increments</router-link>
          </li> 
          ...
          <li>
            <router-link to="/dailyStatus" :class="{ active: activeItem === 'Daily Status' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Daily Status</router-link>
          </li>
          <li>
            <router-link to="/leaves" :class="{ active: activeItem === 'Leaves' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Leaves</router-link>
          </li>
          <li>
            <router-link to="/assets" :class="{ active: activeItem === 'Assets' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Assets</router-link>
          </li>
          <li>
            <router-link to="/entertainment" :class="{ active: activeItem === 'Entertainment' }" class="text-gray-400 hover:text-gray-700 text-[13px] lg:text-[14px]">Entertainment</router-link>
          </li>
          <li class="">
